...
<table>
  <tr>
    <td valign="top"><img src="docs/luxcurve.png" alt="LuxCurve calibration window" width="480"></td>
    <td valign="top"><img src="docs/luxcurve-menu.png" alt="LuxCurve menu-bar dropdown" width="219"></td>
  </tr>
</table>

*The guided calibration window (left) and the menu-bar item (right), shown at their relative sizes.*
